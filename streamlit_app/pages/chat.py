...
from utils.api_client import query_backend, document_upload_rag, PYTHON_BASE_URL
...
def stream_response(query: str, session_id: str, api_url: str):
    """Streams tokens from FastAPI SSE endpoint."""
    url = f"{api_url}/rag/stream"
...
if user_input:
    ...
    with st.chat_message("assistant"):
        response = stream_response(user_input, st.session_state["session_id"], PYTHON_BASE_URL)
