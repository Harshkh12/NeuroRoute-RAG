...
from src.llms.router import llm
...
def routing_tool(state: State) -> Literal["adaptive_k", "general_llm", "web_search", "retriever"]:
    """
    ...
    Returns:
        The next node to execute: "adaptive_k", "general_llm", or "web_search".
    """
